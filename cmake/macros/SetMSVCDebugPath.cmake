...
IF(MSVC)
	...
	SET(TMP_PDB_FILENAME "$<TARGET_FILE_DIR:${_target}>/${TMP_OUTPUT_NAME}.pdb")
	SET_TARGET_PROPERTIES(${_target} PROPERTIES PDB ${TMP_PDB_FILENAME})

	UNSET(TMP_OUTPUT_NAME)
	UNSET(TMP_PDB_FILENAME)
ENDIF(MSVC)
