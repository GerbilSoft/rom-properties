...
IF(MSVC)
	...
	GET_TARGET_PROPERTY(PDB_LOCATION ${_target} LOCATION)
	GET_FILENAME_COMPONENT(PDB_DIRECTORY ${PDB_LOCATION} DIRECTORY)
	SET(PDB_FILENAME "${PDB_DIRECTORY}/${_target}.pdb")

	SET_TARGET_PROPERTIES(${_target} PROPERTIES PDB ${PDB_FILENAME})
