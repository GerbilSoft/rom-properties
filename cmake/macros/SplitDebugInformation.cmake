...
IF(SPLIT_OK)
	...
	GET_FILENAME_COMPONENT(SPLITDEBUG_EXE_DIRECTORY ${SPLITDEBUG_EXE_LOCATION} DIRECTORY)
	...
	ADD_CUSTOM_COMMAND(TARGET ${EXE_TARGET} POST_BUILD
		COMMAND ${CMAKE_OBJCOPY} --only-keep-debug
			${SPLITDEBUG_EXE_LOCATION} "${SPLITDEBUG_EXE_DIRECTORY}/${EXE_TARGET}.debug"
		COMMAND ${CMAKE_STRIP}
	...
	UNSET(SPLITDEBUG_EXE_DIRECTORY)
ENDIF(SPLIT_OK)
