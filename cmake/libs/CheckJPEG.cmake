...
IF(NOT USE_INTERNAL_JPEG)
	...
	ELSE()
		...
		SET(USE_INTERNAL_JPEG ON CACHE BOOL "Use the internal copy of libjpeg" FORCE)
	ENDIF()
ELSE()
	IF(NOT WIN32)
...
IF(USE_INTERNAL_JPEG)
	...
	IF(WIN32 OR APPLE)
		...
		SET(JPEG_LIBRARY jpeg CACHE INTERNAL "JPEG library" FORCE)
	ELSE()
		# Using static linking on other systems.
		SET(USE_INTERNAL_JPEG_DLL OFF)
		SET(JPEG_LIBRARY jpeg-static CACHE INTERNAL "JPEG library" FORCE)
	ENDIF()
