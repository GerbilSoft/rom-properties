...
SET(CFLAGS_WARNINGS -Wall -Wextra -Wno-multichar -Werror=return-type -Wheader-hygiene -Wno-psabi -Winit-self)
...
IF(CMAKE_CXX_COMPILER_ID STREQUAL "Clang")
	SET(RP_CXX_FLAGS_DEBUG "${RP_CXX_FLAGS_DEBUG} -D_LIBCPP_ASSERT=1 -D_LIBCPP_DEBUG=1")

	IF(CMAKE_CXX_COMPILER_VERSION VERSION_GREATER 16.50)
		# clang-17: Use _LIBCPP_HARDENING_MODE.
		# FIXME: On Gentoo, clang-22 complains that _LIBCPP_HARDENING_MODE is redefined.
		SET(RP_CXX_FLAGS_DEBUG "${RP_CXX_FLAGS_DEBUG} -Wno-macro-redefined -D_LIBCPP_HARDENING_MODE=_LIBCPP_HARDENING_MODE_DEBUG")
	ELSE(CMAKE_CXX_COMPILER_VERSION VERSION_GREATER 16.50)
		# clang-16 or earlier: Use _LIBCPP_ENABLE_HARD_MODE and _LIBCPP_ENABLE_ASSERTIONS.
		# NOTE: _LIBCPP_ENABLE_ASSERTIONS causes an error if using clang-17 or later.
		# NOTE: _LIBCPP_ENABLE_HARDENED_MODE causes an error if using clang-22 or later.
		SET(RP_CXX_FLAGS_DEBUG "${RP_CXX_FLAGS_DEBUG} -D_LIBCPP_ENABLE_HARDENED_MODE=1 -D_LIBCPP_ENABLE_ASSERTIONS=1")
	ENDIF(CMAKE_CXX_COMPILER_VERSION VERSION_GREATER 16.50)

	# Remove libc++ transitive includes.
	SET(RP_CXX_FLAGS_DEBUG "${RP_CXX_FLAGS_DEBUG} -D_LIBCPP_REMOVE_TRANSITIVE_INCLUDES=1")
	SET(RP_CXX_FLAGS_RELEASE "${RP_CXX_FLAGS_RELEASE} -D_LIBCPP_REMOVE_TRANSITIVE_INCLUDES=1")
	SET(RP_CXX_FLAGS_RELWITHDEBINFO "${RP_CXX_FLAGS_RELWITHDEBINFO} -D_LIBCPP_REMOVE_TRANSITIVE_INCLUDES=1")
