...
# - C4133: 'expression': incompatible types - from 'type1' to 'type2' [e.g. passing char* to a TCHAR* function or vice-versa]
SET(RP_C_FLAGS_COMMON "/nologo /W3")
IF(ENABLE_WERROR)
	SET(RP_C_FLAGS_COMMON "${RP_C_FLAGS_COMMON} /WX")
ENDIF(ENABLE_WERROR)
SET(RP_C_FLAGS_COMMON "${RP_C_FLAGS_COMMON} /wd4005 /wd4091 /wd4355 /wd4503 /wd4800 /we4013 /we4024 /we4047 /we4477 /we4133")
...
#
# NOTE: MSVC ASan doesn't work properly with /DEPENDENTLOADFLAG
# due to needing an extra DLL.
IF(MSVC_VERSION GREATER 1909 AND NOT ENABLE_SANITIZE)
...
ENDIF(MSVC_VERSION GREATER 1909 AND NOT ENABLE_SANITIZE)
...
IF(CPU_arm OR CPU_arm64)
	SET(RP_MSVC_OPT_FLAGS_RELEASE	"/OPT:REF,ICF,LBR")
ELSE(CPU_arm OR CPU_arm64)
	SET(RP_MSVC_OPT_FLAGS_RELEASE	"/OPT:REF,ICF")
ENDIF(CPU_arm OR CPU_arm64)

SET(RP_C_FLAGS_RELEASE			"/Zi /O2 /Gw")
SET(RP_CXX_FLAGS_RELEASE		"/Zi /O2 /Gw")
SET(RP_EXE_LINKER_FLAGS_RELEASE		"/DEBUG /INCREMENTAL:NO ${RP_MSVC_OPT_FLAGS_RELEASE}")
...
SET(RP_C_FLAGS_RELWITHDEBINFO			"/Zi /O2 /Gw")
SET(RP_CXX_FLAGS_RELWITHDEBINFO			"/Zi /O2 /Gw")
SET(RP_EXE_LINKER_FLAGS_RELWITHDEBINFO		"/DEBUG /INCREMENTAL:NO ${RP_MSVC_OPT_FLAGS_RELEASE}")
