...
IF EXIST "%PROGRAMFILES%\Microsoft Visual Studio\2022\Community\VC\Tools\MSVC\14.33.31629\bin\HostX86\x86\cl.exe" (
	SET "MSVC32_DIR=%PROGRAMFILES%\Microsoft Visual Studio\2022\Community\VC\Tools\MSVC\14.16.27023"
	SET "MSVC32_VERSION=14.16"
	...
	SET "MSVC64_DIR=%PROGRAMFILES%\Microsoft Visual Studio\2022\Community\VC\Tools\MSVC\14.33.31629"
...
IF EXIST "%PROGRAMFILES%\Microsoft Visual Studio\2022\Professional\VC\Tools\MSVC\14.16.27023\bin\HostX86\x86\cl.exe" (
	SET "MSVC32_DIR=%PROGRAMFILES%\Microsoft Visual Studio\2022\Professional\VC\Tools\MSVC\14.16.27023"
	SET "MSVC32_VERSION=14.16"
	SET "MSVC32_YEAR=2022"
	SET "CMAKE32_GENERATOR=17 2022"
	SET "CMAKE32_TOOLSET=v141_xp"
	...
	SET "MSVC64_DIR=%PROGRAMFILES%\Microsoft Visual Studio\2022\Professional\VC\Tools\MSVC\14.33.31629"
	SET "MSVC64_VERSION=14.33"
	SET "MSVC64_YEAR=2022"
	SET "CMAKE64_GENERATOR=17 2022"
	SET "CMAKE64_TOOLSET=v143"
...
IF EXIST "%PROGRAMFILES%\Microsoft Visual Studio\2022\Enterprise\VC\Tools\MSVC\14.16.27023\bin\HostX86\x86\cl.exe" (
	SET "MSVC32_DIR=%PROGRAMFILES%\Microsoft Visual Studio\2022\Enterprise\VC\Tools\MSVC\14.16.27023"
	SET "MSVC32_VERSION=14.16"
	SET "MSVC32_YEAR=2022"
	SET "CMAKE32_GENERATOR=17 2022"
	SET "CMAKE32_TOOLSET=v141_xp"
	...
	SET "MSVC64_DIR=%PROGRAMFILES%\Microsoft Visual Studio\2022\Enterprise\VC\Tools\MSVC\14.33.31629"
	SET "MSVC64_VERSION=14.33"
	SET "MSVC64_YEAR=2022"
	SET "CMAKE64_GENERATOR=17 2022"
	SET "CMAKE64_TOOLSET=v143"
