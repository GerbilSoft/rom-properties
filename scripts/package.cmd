...
IF EXIST "%PRGFILES%\Microsoft Visual Studio\2017\Community\VC\Tools\MSVC\14.15.26726\bin\HostX86\x86\cl.exe" (
	SET "MSVC_DIR=%PRGFILES%\Microsoft Visual Studio\2017\Community\VC\Tools\MSVC\14.15.26726"
	SET MSVC_VERSION=14.14
	SET MSVC_YEAR=2017
	SET "CMAKE_GENERATOR=15 2017"
	SET CMAKE_TOOLSET=v141_xp
)
IF EXIST "%PRGFILES%\Microsoft Visual Studio\2017\Professional\VC\Tools\MSVC\14.15.26726\bin\HostX86\x86\cl.exe" (
	SET "MSVC_DIR=%PRGFILES%\Microsoft Visual Studio\2017\Professional\VC\Tools\MSVC\14.15.26726"
	SET MSVC_VERSION=14.14
	SET MSVC_YEAR=2017
	SET "CMAKE_GENERATOR=15 2017"
	SET CMAKE_TOOLSET=v141_xp
)
IF EXIST "%PRGFILES%\Microsoft Visual Studio\2017\Enterprise\VC\Tools\MSVC\14.15.26726\bin\HostX86\x86\cl.exe" (
	SET "MSVC_DIR=%PRGFILES%\Microsoft Visual Studio\2017\Enterprise\VC\Tools\MSVC\14.15.26726"
	SET MSVC_VERSION=14.14
	SET MSVC_YEAR=2017
	SET "CMAKE_GENERATOR=15 2017"
	SET CMAKE_TOOLSET=v141_xp
