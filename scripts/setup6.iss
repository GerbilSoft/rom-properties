...
begin
  ...
  propdesc_file := ExpandConstant('{app}\{#MyAppVersion}\rom-properties.propdesc');
...
#sub ProcessFoundFile_arm64_dll
  ...
  #define file_check "IsArm64"
    ...
    #define do_regserver ""
  #endif
  Source: "..\pkg_windows\build.arm64ec\bin\Release\{#FileName}"; DestDir: "{app}\{#MyAppVersion}\arm64"; Components: main; Flags: ignoreversion uninsrestartdelete {#file_bits} {#do_regserver}; Check: {#file_check}
#endsub
#sub ProcessFoundFile_arm64_exe
  #define FileName FindGetFileName(FindHandle)
  #define file_bits "64bit"
  #define file_check "IsArm64"
  Source: "..\pkg_windows\build.arm64\bin\Release\{#FileName}"; DestDir: "{app}\{#MyAppVersion}\arm64"; Components: main; Flags: ignoreversion uninsrestartdelete {#file_bits}; Check: {#file_check}
#endsub
...
Source: "..\pkg_windows\build.i386\bin\Release\rpcli.exe"; DestDir: "{app}\{#MyAppVersion}"; Components: main; Flags: ignoreversion; Check: IsX86OS
Source: "..\pkg_windows\build.amd64\bin\Release\rpcli.exe"; DestDir: "{app}\{#MyAppVersion}"; Components: main; Flags: ignoreversion; Check: IsX64OS
Source: "..\pkg_windows\build.arm64\bin\Release\rpcli.exe"; DestDir: "{app}\{#MyAppVersion}"; Components: main; Flags: ignoreversion; Check: IsArm64

Source: "..\pkg_windows\build.i386\bin\Release\rp-config.exe"; DestDir: "{app}\{#MyAppVersion}"; Components: main; Flags: ignoreversion; Check: IsX86OS
Source: "..\pkg_windows\build.amd64\bin\Release\rp-config.exe"; DestDir: "{app}\{#MyAppVersion}"; Components: main; Flags: ignoreversion; Check: IsX64OS
Source: "..\pkg_windows\build.arm64\bin\Release\rp-config.exe"; DestDir: "{app}\{#MyAppVersion}"; Components: main; Flags: ignoreversion; Check: IsArm64
...
[Icons]
Name: "{autoprograms}\ROM Properties Page configuration"; Filename: "{app}\{#MyAppVersion}\rp-config.exe"
