...
class KhronosKTXPrivate;
class KhronosKTX : public LibRpBase::RomData
{
	public:
		/**
		 ...
		 */
		explicit KhronosKTX(LibRpBase::IRpFile *file);
	...
	private:
		...
		friend class KhronosKTXPrivate;
		RP_DISABLE_COPY(KhronosKTX)
