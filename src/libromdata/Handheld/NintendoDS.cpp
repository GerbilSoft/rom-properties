...
class NintendoDSPrivate : public RomDataPrivate
{
	...
	public:
		 ...
		 *
		 * @return True if the Blowfish tables are present; false if not.
		 */
...
int NintendoDS::loadFieldData(void)
{
	...
	static const char *const nds_security_data_names[] = {
		NOP_C_("SecurityData", "Blowfish Tables"),
		NOP_C_("SecurityData", "Static Data"),
		NOP_C_("SecurityData", "Random Data"),
	};
	vector<string> *const v_nds_security_data_names = RomFields::strArrayToVector_i18n(
		"SecurityData", nds_security_data_names, ARRAY_SIZE(nds_security_data_names));
