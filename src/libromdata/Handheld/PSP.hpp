...
#ifndef __ROMPROPERTIES_LIBROMDATA_HANDHELD_PSP_HPP__
#define __ROMPROPERTIES_LIBROMDATA_HANDHELD_PSP_HPP__
...
#endif /* __ROMPROPERTIES_LIBROMDATA_HANDHELD_PSP_HPP__ */
