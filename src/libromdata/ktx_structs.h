...
// NOTE: This header currently requires recent OpenGL header
// to be installed on the system. The relevant OpenGL definitions
// should be added to a local gl_defs.h file later.
#include <GL/gl.h>
