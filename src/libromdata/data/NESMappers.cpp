...
// Mapper 001: MMC1
static const array<NESSubmapperInfo, 5> mmc1_submappers = {{
...
static const array<NESSubmapperInfo, 3> discrete_logic_submappers = {{
...
// Mapper 004: MMC3
static const array<NESSubmapperInfo, 5> mmc3_submappers = {{
...
static const array<NESSubmapperInfo, 8> mapper006_submappers = {{
...
static const array<NESSubmapperInfo, 5> bandai_fcgx_submappers = {{
...
static const array<NESSubmapperInfo, 6> namco_129_164_submappers = {{
...
static const array<NESSubmapperInfo, 2> vrc4a_vrc4c_submappers = {{
	{1, 0,   0, NESMirroring::Unknown, "VRC4a"},
	{2, 0,   0, NESMirroring::Unknown, "VRC4c"},
}};

// Mapper 023: Konami VRC4e, VRC4f, VRC2b
static const array<NESSubmapperInfo, 3> vrc4ef_vrc2b_submappers = {{
...
static const array<NESSubmapperInfo, 3> vrc4bd_vrc2c_submappers = {{
...
static const array<NESSubmapperInfo, 2> irem_g101_submappers = {{
...
static const array<NESSubmapperInfo, 3> cony_yoko_submappers = {{
...
static const array<NESSubmapperInfo, 4> mapper108_submappers = {{
...
static const array<NESSubmapperInfo, 2> mapper114_submappers = {{
...
static const array<NESSubmapperInfo, 4> mapper197_submappers = {{
...
static const array<NESSubmapperInfo, 2> namcot_175_340_submappers = {{
...
static const array<NESSubmapperInfo, 2> smd132_smd133_submappers = {{
...
static const array<NESSubmapperInfo, 5> mapper313_submappers = {{
...
static const array<NESSubmapperInfo, 4> mapper444_submappers = {{
...
static const array<NESSubmapperInfo, 2> mapper458_submappers = {{
...
{
	static const array<const char*, 80> exp_hw_tbl = {{
		// 0x00
		...
		NOP_C_("NES|Expansion", "Vs. System (1P via $4016)"),
		NOP_C_("NES|Expansion", "Vs. System (1P via $4017)"),
		NOP_C_("NES|Expansion", "Vs. Pinball (Japan)"),
		NOP_C_("NES|Expansion", "Vs. Zapper"),
		NOP_C_("NES|Expansion", "Zapper ($4017)"),
		NOP_C_("NES|Expansion", "Two Zappers"),
		NOP_C_("NES|Expansion", "Bandai Hyper Shot Lightgun"),
		...
		NOP_C_("NES|Expansion", "Konami Hyper Shot Controller"),
		...
		NOP_C_("NES|Expansion", "Yonezawa Party Tap"),
		...
		NOP_C_("NES|Expansion", "Pokkun Mogura Tap-tap Mat"),
		NOP_C_("NES|Expansion", "Top Rider (Handlebars)"),
		NOP_C_("NES|Expansion", "Double-Fisted"),
		NOP_C_("NES|Expansion", "Famicom 3D System"),
		NOP_C_("NES|Expansion", "Doremikko Keyboard"),
		NOP_C_("NES|Expansion", "R.O.B. Gyromite"),

		// 0x20
		NOP_C_("NES|Expansion", "Famicom Data Recorder (\"silent\" keyboard)"),
		...
		NOP_C_("NES|Expansion", "Dōngdá PEC Keyboard"),
		NOP_C_("NES|Expansion", "Bit Corp. Bit-79 Keyboard"),
		NOP_C_("NES|Expansion", "Subor Keyboard"),
		NOP_C_("NES|Expansion", "Subor Keyboard plus Macro Winners Mouse"),
		NOP_C_("NES|Expansion", "Subor Keyboard plus Subor Mouse via $4016"),
		NOP_C_("NES|Expansion", "SNES Mouse ($4016)"),
		...
		// 0x30
		NOP_C_("NES|Expansion", "Sharp C1 Cassette Interface"),
		NOP_C_("NES|Expansion", "Standard Controller with Swapped Left-Right/Up-Down/B-A"),
		NOP_C_("NES|Expansion", "Excalibur Sudoku Pad"),
		NOP_C_("NES|Expansion", "ABL Pinball"),
		NOP_C_("NES|Expansion", "Golden Nugget Casino extra buttons"),
		NOP_C_("NES|Expansion", "Kēdá Keyboard"),
		NOP_C_("NES|Expansion", "Subor Keyboard plus Subor Mouse via $4017"),
		NOP_C_("NES|Expansion", "Port test controller"),
		NOP_C_("NES|Expansion", "Bandai Multi Game Player Gamepad buttons"),
		NOP_C_("NES|Expansion", "Venom TV Dance Mat"),
		NOP_C_("NES|Expansion", "LG TV Remote Control"),
		NOP_C_("NES|Expansion", "Famicom Network Controller"),
		NOP_C_("NES|Expansion", "King Fishing Controller"),
		NOP_C_("NES|Expansion", "Croaky Karaoke Controller"),
		NOP_C_("NES|Expansion", "Kingwon Keyboard"),
		NOP_C_("NES|Expansion", "Zéchéng Keyboard"),

		// 0x40
		NOP_C_("NES|Expansion", "Subor Keyboard plus L90-rotated PS/2 mouse in $4017"),
		NOP_C_("NES|Expansion", "PS/2 Keyboard in UM6578 PS/2 port, PS/2 Mouse via $4017"),
		NOP_C_("NES|Expansion", "PS/2 Mouse in UM6578 PS/2 port"),
		NOP_C_("NES|Expansion", "Yùxìng Mouse via $4016"),
		NOP_C_("NES|Expansion", "Subor Keyboard plus Yùxìng Mouse in $4016"),
		NOP_C_("NES|Expansion", "Gigggle TV Pump"),
		NOP_C_("NES|Expansion", "BBK Keyboard plus R90-rotated PS/2 mouse in $4017"),
		NOP_C_("NES|Expansion", "Magical Cooking"),
		NOP_C_("NES|Expansion", "SNES Mouse ($4017)"),
	...
	if (exp_hw < exp_hw_tbl.size()) {
		return pgettext_expr("NES|Expansion", exp_hw_tbl[exp_hw]);
	}
	return nullptr;
}
