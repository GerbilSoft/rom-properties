...
const AmiiboDataPrivate::char_id_t AmiiboDataPrivate::char_ids[] = {
	...
	AMIIBO_CHAR_ID_VAR(0x0000, _RP("Mario"), smb_mario_variants),
	AMIIBO_CHAR_ID_ONE(0x0001, _RP("Luigi")),
	AMIIBO_CHAR_ID_ONE(0x0002, _RP("Peach")),
	AMIIBO_CHAR_ID_VAR(0x0003, _RP("Yoshi"), smb_yoshi_variants),
	AMIIBO_CHAR_ID_VAR(0x0004, _RP("Rosalina"), smb_rosalina_variants),
	AMIIBO_CHAR_ID_VAR(0x0005, _RP("Bowser"), smb_bowser_variants),
	AMIIBO_CHAR_ID_ONE(0x0006, _RP("Bowser Jr.")),
	AMIIBO_CHAR_ID_ONE(0x0007, _RP("Wario")),
	AMIIBO_CHAR_ID_VAR(0x0008, _RP("Donkey Kong"), smb_donkey_kong_variants),
	AMIIBO_CHAR_ID_ONE(0x0009, _RP("Diddy Kong")),
	AMIIBO_CHAR_ID_ONE(0x000A, _RP("Toad")),
	AMIIBO_CHAR_ID_ONE(0x0013, _RP("Daisy")),
	AMIIBO_CHAR_ID_ONE(0x0014, _RP("Waluigi")),
	AMIIBO_CHAR_ID_ONE(0x0017, _RP("Boo")),

	// Yoshi (character series = 0x008)
	AMIIBO_CHAR_ID_VAR(0x0080, _RP("Poochy"), yoshi_poochy_variants),

	// The Legend of Zelda (character series = 0x010)
	AMIIBO_CHAR_ID_VAR(0x0100, _RP("Link"), tloz_link_variants),
	AMIIBO_CHAR_ID_VAR(0x0101, _RP("Zelda"), tloz_zelda_variants),
	AMIIBO_CHAR_ID_VAR(0x0102, _RP("Ganondorf"), tloz_ganondorf_variants),
	AMIIBO_CHAR_ID_ONE(0x0103, _RP("Midna & Wolf Link")),
	// The Legend of Zelda (character series = 0x014)
	AMIIBO_CHAR_ID_ONE(0x0141, _RP("Bokoblin")),

	// Animal Crossing (character series = 0x018)
	AMIIBO_CHAR_ID_ONE(0x0180, _RP("Villager")),
	AMIIBO_CHAR_ID_VAR(0x0181, _RP("Isabelle"), ac_isabelle_variants),
	AMIIBO_CHAR_ID_ONE(0x0182, _RP("DJ KK")),
	AMIIBO_CHAR_ID_VAR(0x0182, _RP("K.K. Slider"), ac_kk_slider_variants),
	AMIIBO_CHAR_ID_VAR(0x0183, _RP("Tom Nook"), ac_tom_nook_variants),
	AMIIBO_CHAR_ID_ONE(0x0184, _RP("Timmy & Tommy")),
	AMIIBO_CHAR_ID_VAR(0x0185, _RP("Timmy"), ac_timmy_variants),
	AMIIBO_CHAR_ID_VAR(0x0186, _RP("Tommy"), ac_tommy_variants),
	AMIIBO_CHAR_ID_ONE(0x0187, _RP("Sable")),
	AMIIBO_CHAR_ID_ONE(0x0188, _RP("Mabel")),
	AMIIBO_CHAR_ID_ONE(0x0189, _RP("Labelle")),
	AMIIBO_CHAR_ID_ONE(0x018A, _RP("Reese")),
	AMIIBO_CHAR_ID_ONE(0x018B, _RP("Cyrus")),
	AMIIBO_CHAR_ID_VAR(0x018C, _RP("Digby"), ac_digby_variants),
	AMIIBO_CHAR_ID_ONE(0x018D, _RP("Rover")),
	AMIIBO_CHAR_ID_VAR(0x018E, _RP("Resetti"), ac_resetti_variants),
	AMIIBO_CHAR_ID_VAR(0x018F, _RP("Don Resetti"), ac_don_resetti_variants),
	AMIIBO_CHAR_ID_ONE(0x0190, _RP("Brewster")),
	AMIIBO_CHAR_ID_ONE(0x0191, _RP("Harriet")),
	AMIIBO_CHAR_ID_ONE(0x0192, _RP("Blathers")),
	AMIIBO_CHAR_ID_ONE(0x0193, _RP("Celeste")),
	AMIIBO_CHAR_ID_ONE(0x0194, _RP("Kicks")),
	AMIIBO_CHAR_ID_ONE(0x0195, _RP("Porter")),
	AMIIBO_CHAR_ID_ONE(0x0196, _RP("Kapp'n")),
	AMIIBO_CHAR_ID_ONE(0x0197, _RP("Leilani")),
	AMIIBO_CHAR_ID_ONE(0x0198, _RP("Lelia")),
	AMIIBO_CHAR_ID_ONE(0x0199, _RP("Grams")),
	AMIIBO_CHAR_ID_ONE(0x019A, _RP("Chip")),
	AMIIBO_CHAR_ID_ONE(0x019B, _RP("Nat")),
	AMIIBO_CHAR_ID_ONE(0x019C, _RP("Phineas")),
	AMIIBO_CHAR_ID_ONE(0x019D, _RP("Copper")),
	AMIIBO_CHAR_ID_ONE(0x019E, _RP("Booker")),
	AMIIBO_CHAR_ID_ONE(0x019F, _RP("Pete")),
	AMIIBO_CHAR_ID_ONE(0x01A0, _RP("Pelly")),
	AMIIBO_CHAR_ID_ONE(0x01A1, _RP("Phyllis")),
	AMIIBO_CHAR_ID_ONE(0x01A2, _RP("Gulliver")),
	AMIIBO_CHAR_ID_ONE(0x01A3, _RP("Joan")),
	AMIIBO_CHAR_ID_ONE(0x01A4, _RP("Pascal")),
	AMIIBO_CHAR_ID_ONE(0x01A5, _RP("Katrina")),
	AMIIBO_CHAR_ID_ONE(0x01A6, _RP("Sahara")),
	AMIIBO_CHAR_ID_ONE(0x01A7, _RP("Wendell")),
	AMIIBO_CHAR_ID_VAR(0x01A8, _RP("Redd"), ac_redd_variants),
	AMIIBO_CHAR_ID_ONE(0x01A9, _RP("Gracie")),
	AMIIBO_CHAR_ID_ONE(0x01AA, _RP("Lyle")),
	AMIIBO_CHAR_ID_ONE(0x01AB, _RP("Pave")),
	AMIIBO_CHAR_ID_ONE(0x01AC, _RP("Zipper")),
	AMIIBO_CHAR_ID_ONE(0x01AD, _RP("Jack")),
	AMIIBO_CHAR_ID_ONE(0x01AE, _RP("Franklin")),
	AMIIBO_CHAR_ID_ONE(0x01AF, _RP("Jingle")),
	AMIIBO_CHAR_ID_ONE(0x01B0, _RP("Tortimer")),
	AMIIBO_CHAR_ID_VAR(0x01B1, _RP("Dr. Shrunk"), ac_dr_shrunk_variants),
	AMIIBO_CHAR_ID_ONE(0x01B3, _RP("Blanca")),
	AMIIBO_CHAR_ID_ONE(0x01B4, _RP("Leif")),
	AMIIBO_CHAR_ID_ONE(0x01B5, _RP("Luna")),
	AMIIBO_CHAR_ID_ONE(0x01B5, _RP("Luna")),
	AMIIBO_CHAR_ID_ONE(0x01B6, _RP("Katie")),
	AMIIBO_CHAR_ID_VAR(0x01C1, _RP("Lottie"), ac_lottie_variants),
	AMIIBO_CHAR_ID_ONE(0x0200, _RP("Cyrano")),
	AMIIBO_CHAR_ID_ONE(0x0201, _RP("Antonio")),
	AMIIBO_CHAR_ID_ONE(0x0202, _RP("Pango")),
	AMIIBO_CHAR_ID_ONE(0x0203, _RP("Anabelle")),
	AMIIBO_CHAR_ID_ONE(0x0206, _RP("Snooty")),
	AMIIBO_CHAR_ID_ONE(0x0208, _RP("Annalisa")),
	AMIIBO_CHAR_ID_ONE(0x0209, _RP("Olaf")),
	AMIIBO_CHAR_ID_ONE(0x0214, _RP("Teddy")),
	AMIIBO_CHAR_ID_ONE(0x0215, _RP("Pinky")),
	AMIIBO_CHAR_ID_ONE(0x0216, _RP("Curt")),
	AMIIBO_CHAR_ID_ONE(0x0217, _RP("Chow")),
	AMIIBO_CHAR_ID_ONE(0x0219, _RP("Nate")),
	AMIIBO_CHAR_ID_ONE(0x021A, _RP("Groucho")),
	AMIIBO_CHAR_ID_ONE(0x021B, _RP("Tutu")),
	AMIIBO_CHAR_ID_ONE(0x021C, _RP("Ursala")),
	AMIIBO_CHAR_ID_ONE(0x021D, _RP("Grizzly")),
	AMIIBO_CHAR_ID_ONE(0x021E, _RP("Paula")),
	AMIIBO_CHAR_ID_ONE(0x021F, _RP("Ike")),
	AMIIBO_CHAR_ID_ONE(0x0220, _RP("Charlise")),
	AMIIBO_CHAR_ID_ONE(0x0221, _RP("Beardo")),
	AMIIBO_CHAR_ID_ONE(0x0222, _RP("Klaus")),
	AMIIBO_CHAR_ID_ONE(0x022D, _RP("Jay")),
	AMIIBO_CHAR_ID_ONE(0x022E, _RP("Robin")),
	AMIIBO_CHAR_ID_ONE(0x022F, _RP("Anchovy")),
	AMIIBO_CHAR_ID_ONE(0x0230, _RP("Twiggy")),
	AMIIBO_CHAR_ID_ONE(0x0231, _RP("Jitters")),
	AMIIBO_CHAR_ID_ONE(0x0232, _RP("Piper")),
	AMIIBO_CHAR_ID_ONE(0x0233, _RP("Admiral")),
	AMIIBO_CHAR_ID_ONE(0x0235, _RP("Midge")),
	AMIIBO_CHAR_ID_ONE(0x0238, _RP("Jacob")),
	AMIIBO_CHAR_ID_ONE(0x023C, _RP("Lucha")),
	AMIIBO_CHAR_ID_ONE(0x023D, _RP("Jacques")),
	AMIIBO_CHAR_ID_ONE(0x023E, _RP("Peck")),
	AMIIBO_CHAR_ID_ONE(0x023F, _RP("Sparro")),
	AMIIBO_CHAR_ID_ONE(0x024A, _RP("Angus")),
	AMIIBO_CHAR_ID_ONE(0x024B, _RP("Rodeo")),
	AMIIBO_CHAR_ID_ONE(0x024D, _RP("Stu")),
	AMIIBO_CHAR_ID_ONE(0x024F, _RP("T-Bone")),
	AMIIBO_CHAR_ID_ONE(0x024F, _RP("T-Bone")),
	AMIIBO_CHAR_ID_ONE(0x0251, _RP("Coach")),
	AMIIBO_CHAR_ID_ONE(0x0252, _RP("Vic")),
	AMIIBO_CHAR_ID_ONE(0x025D, _RP("Bob")),
	AMIIBO_CHAR_ID_ONE(0x025E, _RP("Mitzi")),
	AMIIBO_CHAR_ID_ONE(0x025F, _RP("Rosie")),	// amiibo Festival variant is in Page 22, amiibo series.
	AMIIBO_CHAR_ID_ONE(0x0260, _RP("Olivia")),
	AMIIBO_CHAR_ID_ONE(0x0261, _RP("Kiki")),
	AMIIBO_CHAR_ID_ONE(0x0262, _RP("Tangy")),
	AMIIBO_CHAR_ID_ONE(0x0263, _RP("Punchy")),
	AMIIBO_CHAR_ID_ONE(0x0264, _RP("Purrl")),
	AMIIBO_CHAR_ID_ONE(0x0265, _RP("Moe")),
	AMIIBO_CHAR_ID_ONE(0x0266, _RP("Kabuki")),
	AMIIBO_CHAR_ID_ONE(0x0267, _RP("Kid Cat")),
	AMIIBO_CHAR_ID_ONE(0x0268, _RP("Monique")),
	AMIIBO_CHAR_ID_ONE(0x0269, _RP("Tabby")),
	AMIIBO_CHAR_ID_ONE(0x026A, _RP("Stinky")),
	AMIIBO_CHAR_ID_ONE(0x026B, _RP("Kitty")),
	AMIIBO_CHAR_ID_ONE(0x026C, _RP("Tom")),
	AMIIBO_CHAR_ID_ONE(0x026D, _RP("Merry")),
	AMIIBO_CHAR_ID_ONE(0x026E, _RP("Felicity")),
	AMIIBO_CHAR_ID_ONE(0x026F, _RP("Lolly")),
	AMIIBO_CHAR_ID_ONE(0x0270, _RP("Ankha")),
	AMIIBO_CHAR_ID_ONE(0x0271, _RP("Rudy")),
	AMIIBO_CHAR_ID_ONE(0x0272, _RP("Katt")),
	AMIIBO_CHAR_ID_ONE(0x027D, _RP("Bluebear")),
	AMIIBO_CHAR_ID_ONE(0x027E, _RP("Maple")),
	AMIIBO_CHAR_ID_ONE(0x027F, _RP("Poncho")),
	AMIIBO_CHAR_ID_ONE(0x0280, _RP("Pudge")),
	AMIIBO_CHAR_ID_ONE(0x0281, _RP("Kody")),
	AMIIBO_CHAR_ID_ONE(0x0282, _RP("Stitches")),	// amiibo Festival variant is in Page 22, amiibo series.
	AMIIBO_CHAR_ID_ONE(0x0283, _RP("Vladimir")),
	AMIIBO_CHAR_ID_ONE(0x0284, _RP("Murphy")),
	AMIIBO_CHAR_ID_ONE(0x0286, _RP("Olive")),
	AMIIBO_CHAR_ID_ONE(0x0287, _RP("Cheri")),
	AMIIBO_CHAR_ID_ONE(0x028A, _RP("June")),
	AMIIBO_CHAR_ID_ONE(0x028B, _RP("Pekoe")),
	AMIIBO_CHAR_ID_ONE(0x028C, _RP("Chester")),
	AMIIBO_CHAR_ID_ONE(0x028D, _RP("Barold")),
	AMIIBO_CHAR_ID_ONE(0x028E, _RP("Tammy")),
	AMIIBO_CHAR_ID_VAR(0x028F, _RP("Marty"), ac_marty_variants),
	AMIIBO_CHAR_ID_ONE(0x0299, _RP("Goose")),
	AMIIBO_CHAR_ID_ONE(0x029A, _RP("Benedict")),
	AMIIBO_CHAR_ID_ONE(0x029B, _RP("Egbert")),
	AMIIBO_CHAR_ID_ONE(0x029E, _RP("Ava")),
	AMIIBO_CHAR_ID_ONE(0x02A2, _RP("Becky")),
	AMIIBO_CHAR_ID_ONE(0x02A3, _RP("Plucky")),
	AMIIBO_CHAR_ID_ONE(0x02A4, _RP("Knox")),
	AMIIBO_CHAR_ID_ONE(0x02A5, _RP("Broffina")),
	AMIIBO_CHAR_ID_ONE(0x02A6, _RP("Ken")),
	AMIIBO_CHAR_ID_ONE(0x02B1, _RP("Patty")),
	AMIIBO_CHAR_ID_ONE(0x02B2, _RP("Tipper")),
	AMIIBO_CHAR_ID_ONE(0x02B7, _RP("Norma")),
	AMIIBO_CHAR_ID_ONE(0x02B8, _RP("Naomi")),
	AMIIBO_CHAR_ID_ONE(0x02C3, _RP("Alfonso")),
	AMIIBO_CHAR_ID_ONE(0x02C4, _RP("Alli")),
	AMIIBO_CHAR_ID_ONE(0x02C5, _RP("Boots")),
	AMIIBO_CHAR_ID_ONE(0x02C7, _RP("Del")),
	AMIIBO_CHAR_ID_ONE(0x02C9, _RP("Sly")),
	AMIIBO_CHAR_ID_ONE(0x02CA, _RP("Gayle")),
	AMIIBO_CHAR_ID_ONE(0x02CB, _RP("Drago")),
	AMIIBO_CHAR_ID_ONE(0x02D6, _RP("Fauna")),
	AMIIBO_CHAR_ID_ONE(0x02D7, _RP("Bam")),
	AMIIBO_CHAR_ID_ONE(0x02D8, _RP("Zell")),
	AMIIBO_CHAR_ID_ONE(0x02D9, _RP("Bruce")),
	AMIIBO_CHAR_ID_ONE(0x02DA, _RP("Deirdre")),
	AMIIBO_CHAR_ID_ONE(0x02DB, _RP("Lopez")),
	AMIIBO_CHAR_ID_ONE(0x02DC, _RP("Fuchsia")),
	AMIIBO_CHAR_ID_ONE(0x02DD, _RP("Beau")),
	AMIIBO_CHAR_ID_ONE(0x02DE, _RP("Diana")),
	AMIIBO_CHAR_ID_ONE(0x02DF, _RP("Erik")),
	AMIIBO_CHAR_ID_VAR(0x02E0, _RP("Chelsea"), ac_chelsea_variants),
	AMIIBO_CHAR_ID_ONE(0x02EA, _RP("Goldie")),	// amiibo Festival variant is in Page 22, amiibo series.
	AMIIBO_CHAR_ID_ONE(0x02EB, _RP("Butch")),
	AMIIBO_CHAR_ID_ONE(0x02EC, _RP("Lucky")),
	AMIIBO_CHAR_ID_ONE(0x02ED, _RP("Biskit")),
	AMIIBO_CHAR_ID_ONE(0x02EE, _RP("Bones")),
	AMIIBO_CHAR_ID_ONE(0x02EF, _RP("Portia")),
	AMIIBO_CHAR_ID_ONE(0x02F0, _RP("Joan")),
	AMIIBO_CHAR_ID_ONE(0x02F0, _RP("Walker")),
	AMIIBO_CHAR_ID_ONE(0x02F1, _RP("Daisy")),
	AMIIBO_CHAR_ID_ONE(0x02F2, _RP("Cookie")),
	AMIIBO_CHAR_ID_ONE(0x02F3, _RP("Maddie")),
	AMIIBO_CHAR_ID_ONE(0x02F4, _RP("Bea")),
	AMIIBO_CHAR_ID_ONE(0x02F8, _RP("Mac")),
	AMIIBO_CHAR_ID_ONE(0x02F9, _RP("Marcel")),
	AMIIBO_CHAR_ID_ONE(0x02FA, _RP("Benjamin")),
	AMIIBO_CHAR_ID_ONE(0x02FB, _RP("Cherry")),
	AMIIBO_CHAR_ID_ONE(0x02FC, _RP("Shep")),
	AMIIBO_CHAR_ID_ONE(0x0307, _RP("Bill")),
	AMIIBO_CHAR_ID_ONE(0x0307, _RP("Bill")),
	AMIIBO_CHAR_ID_ONE(0x0308, _RP("Joey")),
	AMIIBO_CHAR_ID_ONE(0x0309, _RP("Pate")),
	AMIIBO_CHAR_ID_ONE(0x030A, _RP("Maelle")),
	AMIIBO_CHAR_ID_ONE(0x030B, _RP("Deena")),
	AMIIBO_CHAR_ID_ONE(0x030C, _RP("Pompom")),
	AMIIBO_CHAR_ID_ONE(0x030D, _RP("Mallary")),
	AMIIBO_CHAR_ID_ONE(0x030E, _RP("Freckles")),
	AMIIBO_CHAR_ID_ONE(0x030F, _RP("Derwin")),
	AMIIBO_CHAR_ID_ONE(0x0310, _RP("Drake")),
	AMIIBO_CHAR_ID_ONE(0x0311, _RP("Scoot")),
	AMIIBO_CHAR_ID_ONE(0x0312, _RP("Weber")),
	AMIIBO_CHAR_ID_ONE(0x0313, _RP("Miranda")),
	AMIIBO_CHAR_ID_ONE(0x0314, _RP("Ketchup")),
	AMIIBO_CHAR_ID_ONE(0x0316, _RP("Gloria")),
	AMIIBO_CHAR_ID_ONE(0x0317, _RP("Molly")),
	AMIIBO_CHAR_ID_ONE(0x0318, _RP("Quillson")),
	AMIIBO_CHAR_ID_ONE(0x0323, _RP("Opal")),
	AMIIBO_CHAR_ID_ONE(0x0324, _RP("Dizzy")),
	AMIIBO_CHAR_ID_ONE(0x0325, _RP("Big Top")),
	AMIIBO_CHAR_ID_ONE(0x0326, _RP("Eloise")),
	AMIIBO_CHAR_ID_ONE(0x0327, _RP("Margie")),
	AMIIBO_CHAR_ID_ONE(0x0328, _RP("Paolo")),
	AMIIBO_CHAR_ID_ONE(0x0329, _RP("Axel")),
	AMIIBO_CHAR_ID_ONE(0x032A, _RP("Ellie")),
	AMIIBO_CHAR_ID_ONE(0x032C, _RP("Tucker")),
	AMIIBO_CHAR_ID_ONE(0x032D, _RP("Tia")),
	AMIIBO_CHAR_ID_VAR(0x032E, _RP("Chai"), ac_chai_variants),
	AMIIBO_CHAR_ID_ONE(0x0338, _RP("Lily")),
	AMIIBO_CHAR_ID_ONE(0x0339, _RP("Ribbot")),
	AMIIBO_CHAR_ID_ONE(0x033A, _RP("Frobert")),
	AMIIBO_CHAR_ID_ONE(0x033B, _RP("Camofrog")),
	AMIIBO_CHAR_ID_ONE(0x033C, _RP("Drift")),
	AMIIBO_CHAR_ID_ONE(0x033D, _RP("Wart Jr.")),
	AMIIBO_CHAR_ID_ONE(0x033E, _RP("Puddles")),
	AMIIBO_CHAR_ID_ONE(0x033F, _RP("Jeremiah")),
	AMIIBO_CHAR_ID_ONE(0x0341, _RP("Tad")),
	AMIIBO_CHAR_ID_ONE(0x0342, _RP("Cousteau")),
	AMIIBO_CHAR_ID_ONE(0x0343, _RP("Huck")),
	AMIIBO_CHAR_ID_ONE(0x0344, _RP("Prince")),
	AMIIBO_CHAR_ID_ONE(0x0345, _RP("Jambette")),
	AMIIBO_CHAR_ID_ONE(0x0347, _RP("Raddle")),
	AMIIBO_CHAR_ID_ONE(0x0348, _RP("Gigi")),
	AMIIBO_CHAR_ID_ONE(0x0349, _RP("Croque")),
	AMIIBO_CHAR_ID_ONE(0x034A, _RP("Diva")),
	AMIIBO_CHAR_ID_ONE(0x034B, _RP("Henry")),
	AMIIBO_CHAR_ID_ONE(0x0356, _RP("Chevre")),
	AMIIBO_CHAR_ID_ONE(0x0357, _RP("Nan")),
	AMIIBO_CHAR_ID_ONE(0x0358, _RP("Billy")),
	AMIIBO_CHAR_ID_ONE(0x035A, _RP("Gruff")),
	AMIIBO_CHAR_ID_ONE(0x035C, _RP("Velma")),
	AMIIBO_CHAR_ID_ONE(0x035D, _RP("Kidd")),
	AMIIBO_CHAR_ID_ONE(0x035E, _RP("Pashmina")),
	AMIIBO_CHAR_ID_ONE(0x0369, _RP("Cesar")),
	AMIIBO_CHAR_ID_ONE(0x036A, _RP("Peewee")),
	AMIIBO_CHAR_ID_ONE(0x036B, _RP("Boone")),
	AMIIBO_CHAR_ID_ONE(0x036D, _RP("Louie")),
	AMIIBO_CHAR_ID_ONE(0x036E, _RP("Boyd")),
	AMIIBO_CHAR_ID_ONE(0x0370, _RP("Violet")),
	AMIIBO_CHAR_ID_ONE(0x0371, _RP("Al")),
	AMIIBO_CHAR_ID_ONE(0x0372, _RP("Rocket")),
	AMIIBO_CHAR_ID_ONE(0x0373, _RP("Hans")),
	AMIIBO_CHAR_ID_VAR(0x0374, _RP("Rilla"), ac_rilla_variants),
	AMIIBO_CHAR_ID_ONE(0x037E, _RP("Hamlet")),
	AMIIBO_CHAR_ID_ONE(0x037F, _RP("Apple")),
	AMIIBO_CHAR_ID_ONE(0x0380, _RP("Graham")),
	AMIIBO_CHAR_ID_ONE(0x0381, _RP("Rodney")),
	AMIIBO_CHAR_ID_ONE(0x0382, _RP("Soleil")),
	AMIIBO_CHAR_ID_ONE(0x0383, _RP("Clay")),
	AMIIBO_CHAR_ID_ONE(0x0384, _RP("Flurry")),
	AMIIBO_CHAR_ID_ONE(0x0385, _RP("Hamphrey")),
	AMIIBO_CHAR_ID_ONE(0x0390, _RP("Rocco")),
	AMIIBO_CHAR_ID_ONE(0x0392, _RP("Bubbles")),
	AMIIBO_CHAR_ID_ONE(0x0393, _RP("Bertha")),
	AMIIBO_CHAR_ID_ONE(0x0394, _RP("Biff")),
	AMIIBO_CHAR_ID_ONE(0x0395, _RP("Bitty")),
	AMIIBO_CHAR_ID_ONE(0x0398, _RP("Harry")),
	AMIIBO_CHAR_ID_ONE(0x0399, _RP("Hippeux")),
	AMIIBO_CHAR_ID_ONE(0x03A4, _RP("Buck")),
	AMIIBO_CHAR_ID_ONE(0x03A5, _RP("Victoria")),
	AMIIBO_CHAR_ID_ONE(0x03A6, _RP("Savannah")),
	AMIIBO_CHAR_ID_ONE(0x03A7, _RP("Elmer")),
	AMIIBO_CHAR_ID_ONE(0x03A8, _RP("Rosco")),
	AMIIBO_CHAR_ID_ONE(0x03A9, _RP("Winnie")),
	AMIIBO_CHAR_ID_ONE(0x03AA, _RP("Ed")),
	AMIIBO_CHAR_ID_ONE(0x03AB, _RP("Cleo")),
	AMIIBO_CHAR_ID_ONE(0x03AC, _RP("Peaches")),
	AMIIBO_CHAR_ID_ONE(0x03AD, _RP("Annalise")),
	AMIIBO_CHAR_ID_ONE(0x03AE, _RP("Clyde")),
	AMIIBO_CHAR_ID_ONE(0x03AF, _RP("Colton")),
	AMIIBO_CHAR_ID_ONE(0x03B0, _RP("Papi")),
	AMIIBO_CHAR_ID_ONE(0x03B1, _RP("Julian")),
	AMIIBO_CHAR_ID_ONE(0x03BC, _RP("Yuka")),
	AMIIBO_CHAR_ID_ONE(0x03BD, _RP("Alice")),
	AMIIBO_CHAR_ID_ONE(0x03BE, _RP("Melba")),
	AMIIBO_CHAR_ID_ONE(0x03BF, _RP("Sydney")),
	AMIIBO_CHAR_ID_ONE(0x03C0, _RP("Gonzo")),
	AMIIBO_CHAR_ID_ONE(0x03C1, _RP("Ozzie")),
	AMIIBO_CHAR_ID_ONE(0x03C4, _RP("Canberra")),
	AMIIBO_CHAR_ID_ONE(0x03C5, _RP("Lyman")),
	AMIIBO_CHAR_ID_ONE(0x03C6, _RP("Eugene")),
	AMIIBO_CHAR_ID_ONE(0x03D1, _RP("Kitt")),
	AMIIBO_CHAR_ID_ONE(0x03D2, _RP("Mathilda")),
	AMIIBO_CHAR_ID_ONE(0x03D3, _RP("Carrie")),
	AMIIBO_CHAR_ID_ONE(0x03D6, _RP("Astrid")),
	AMIIBO_CHAR_ID_ONE(0x03D7, _RP("Sylvia")),
	AMIIBO_CHAR_ID_ONE(0x03D9, _RP("Walt")),
	AMIIBO_CHAR_ID_ONE(0x03DA, _RP("Rooney")),
	AMIIBO_CHAR_ID_ONE(0x03DB, _RP("Marcie")),
	AMIIBO_CHAR_ID_ONE(0x03E6, _RP("Bud")),
	AMIIBO_CHAR_ID_ONE(0x03E7, _RP("Elvis")),
	AMIIBO_CHAR_ID_ONE(0x03E8, _RP("Rex")),
	AMIIBO_CHAR_ID_ONE(0x03EA, _RP("Leopold")),
	AMIIBO_CHAR_ID_ONE(0x03EC, _RP("Mott")),
	AMIIBO_CHAR_ID_ONE(0x03ED, _RP("Rory")),
	AMIIBO_CHAR_ID_ONE(0x03EE, _RP("Lionel")),
	AMIIBO_CHAR_ID_ONE(0x03FA, _RP("Nana")),
	AMIIBO_CHAR_ID_ONE(0x03FB, _RP("Simon")),
	AMIIBO_CHAR_ID_ONE(0x03FC, _RP("Tammi")),
	AMIIBO_CHAR_ID_ONE(0x03FD, _RP("Monty")),
	AMIIBO_CHAR_ID_ONE(0x03FE, _RP("Elise")),
	AMIIBO_CHAR_ID_ONE(0x03FF, _RP("Flip")),
	AMIIBO_CHAR_ID_ONE(0x0400, _RP("Shari")),
	AMIIBO_CHAR_ID_ONE(0x0401, _RP("Deli")),
	AMIIBO_CHAR_ID_ONE(0x040C, _RP("Dora")),
	AMIIBO_CHAR_ID_ONE(0x040D, _RP("Limberg")),
	AMIIBO_CHAR_ID_ONE(0x040E, _RP("Bella")),
	AMIIBO_CHAR_ID_ONE(0x040F, _RP("Bree")),
	AMIIBO_CHAR_ID_ONE(0x0410, _RP("Samson")),
	AMIIBO_CHAR_ID_ONE(0x0411, _RP("Rod")),
	AMIIBO_CHAR_ID_ONE(0x0414, _RP("Candi")),
	AMIIBO_CHAR_ID_ONE(0x0415, _RP("Rizzo")),
	AMIIBO_CHAR_ID_ONE(0x0416, _RP("Anicotti")),
	AMIIBO_CHAR_ID_ONE(0x0418, _RP("Broccolo")),
	AMIIBO_CHAR_ID_ONE(0x041A, _RP("Moose")),
	AMIIBO_CHAR_ID_ONE(0x041B, _RP("Bettina")),
	AMIIBO_CHAR_ID_ONE(0x041C, _RP("Greta")),
	AMIIBO_CHAR_ID_ONE(0x041D, _RP("Penelope")),
	AMIIBO_CHAR_ID_ONE(0x041E, _RP("Chadder")),
	AMIIBO_CHAR_ID_ONE(0x0429, _RP("Octavian")),
	AMIIBO_CHAR_ID_ONE(0x042A, _RP("Marina")),
	AMIIBO_CHAR_ID_ONE(0x042B, _RP("Zucker")),
	AMIIBO_CHAR_ID_ONE(0x0436, _RP("Queenie")),
	AMIIBO_CHAR_ID_ONE(0x0437, _RP("Gladys")),
	AMIIBO_CHAR_ID_ONE(0x0438, _RP("Sandy")),
	AMIIBO_CHAR_ID_ONE(0x0439, _RP("Sprocket")),
	AMIIBO_CHAR_ID_ONE(0x043B, _RP("Julia")),
	AMIIBO_CHAR_ID_ONE(0x043C, _RP("Cranston")),
	AMIIBO_CHAR_ID_ONE(0x043D, _RP("Phil")),
	AMIIBO_CHAR_ID_ONE(0x043E, _RP("Blanche")),
	AMIIBO_CHAR_ID_ONE(0x043F, _RP("Flora")),
	AMIIBO_CHAR_ID_ONE(0x0440, _RP("Phoebe")),
	AMIIBO_CHAR_ID_ONE(0x044B, _RP("Apollo")),
	AMIIBO_CHAR_ID_ONE(0x044C, _RP("Amelia")),
	AMIIBO_CHAR_ID_ONE(0x044D, _RP("Pierce")),
	AMIIBO_CHAR_ID_ONE(0x044E, _RP("Buzz")),
	AMIIBO_CHAR_ID_ONE(0x0450, _RP("Avery")),
	AMIIBO_CHAR_ID_ONE(0x0451, _RP("Frank")),
	AMIIBO_CHAR_ID_ONE(0x0452, _RP("Sterling")),
	AMIIBO_CHAR_ID_ONE(0x0453, _RP("Keaton")),
	AMIIBO_CHAR_ID_ONE(0x0454, _RP("Celia")),
	AMIIBO_CHAR_ID_ONE(0x045F, _RP("Aurora")),
	AMIIBO_CHAR_ID_ONE(0x0460, _RP("Joan")),
	AMIIBO_CHAR_ID_ONE(0x0460, _RP("Roald")),
	AMIIBO_CHAR_ID_ONE(0x0461, _RP("Cube")),
	AMIIBO_CHAR_ID_ONE(0x0462, _RP("Hopper")),
	AMIIBO_CHAR_ID_ONE(0x0463, _RP("Friga")),
	AMIIBO_CHAR_ID_ONE(0x0464, _RP("Gwen")),
	AMIIBO_CHAR_ID_ONE(0x0465, _RP("Puck")),
	AMIIBO_CHAR_ID_ONE(0x0468, _RP("Wade")),
	AMIIBO_CHAR_ID_ONE(0x0469, _RP("Boomer")),
	AMIIBO_CHAR_ID_ONE(0x046A, _RP("Iggly")),
	AMIIBO_CHAR_ID_ONE(0x046B, _RP("Tex")),
	AMIIBO_CHAR_ID_ONE(0x046C, _RP("Flo")),
	AMIIBO_CHAR_ID_ONE(0x046D, _RP("Sprinkle")),
	AMIIBO_CHAR_ID_ONE(0x0478, _RP("Curly")),
	AMIIBO_CHAR_ID_ONE(0x0479, _RP("Truffles")),
	AMIIBO_CHAR_ID_ONE(0x047A, _RP("Rasher")),
	AMIIBO_CHAR_ID_ONE(0x047B, _RP("Hugh")),
	AMIIBO_CHAR_ID_ONE(0x047C, _RP("Lucy")),
	AMIIBO_CHAR_ID_ONE(0x047D, _RP("Spork/Crackle")),
	AMIIBO_CHAR_ID_ONE(0x0480, _RP("Cobb")),
	AMIIBO_CHAR_ID_ONE(0x0481, _RP("Boris")),
	AMIIBO_CHAR_ID_ONE(0x0482, _RP("Maggie")),
	AMIIBO_CHAR_ID_ONE(0x0483, _RP("Peggy")),
	AMIIBO_CHAR_ID_ONE(0x0485, _RP("Gala")),
	AMIIBO_CHAR_ID_ONE(0x0486, _RP("Chops")),
	AMIIBO_CHAR_ID_ONE(0x0487, _RP("Kevin")),
	AMIIBO_CHAR_ID_ONE(0x0488, _RP("Pancetti")),
	AMIIBO_CHAR_ID_ONE(0x0489, _RP("Agnes")),
	AMIIBO_CHAR_ID_ONE(0x0494, _RP("Bunnie")),
	AMIIBO_CHAR_ID_ONE(0x0495, _RP("Dotty")),
	AMIIBO_CHAR_ID_ONE(0x0496, _RP("Coco")),
	AMIIBO_CHAR_ID_ONE(0x0497, _RP("Snake")),
	AMIIBO_CHAR_ID_ONE(0x0498, _RP("Gaston")),
	AMIIBO_CHAR_ID_ONE(0x0499, _RP("Gabi")),
	AMIIBO_CHAR_ID_ONE(0x049A, _RP("Pippy")),
	AMIIBO_CHAR_ID_ONE(0x049B, _RP("Tiffany")),
	AMIIBO_CHAR_ID_ONE(0x049C, _RP("Genji")),
	AMIIBO_CHAR_ID_ONE(0x049D, _RP("Ruby")),
	AMIIBO_CHAR_ID_ONE(0x049E, _RP("Doc")),
	AMIIBO_CHAR_ID_ONE(0x049F, _RP("Claude")),
	AMIIBO_CHAR_ID_ONE(0x04A0, _RP("Francine")),
	AMIIBO_CHAR_ID_ONE(0x04A1, _RP("Chrissy")),
	AMIIBO_CHAR_ID_ONE(0x04A2, _RP("Hopkins")),
	AMIIBO_CHAR_ID_ONE(0x04A3, _RP("OHare")),
	AMIIBO_CHAR_ID_ONE(0x04A4, _RP("Carmen")),
	AMIIBO_CHAR_ID_ONE(0x04A5, _RP("Bonbon")),
	AMIIBO_CHAR_ID_ONE(0x04A6, _RP("Cole")),
	AMIIBO_CHAR_ID_ONE(0x04A7, _RP("Mira")),
	AMIIBO_CHAR_ID_VAR(0x04A8, _RP("Toby"), ac_toby_variants),
	AMIIBO_CHAR_ID_ONE(0x04B2, _RP("Tank")),
	AMIIBO_CHAR_ID_ONE(0x04B3, _RP("Rhonda")),
	AMIIBO_CHAR_ID_ONE(0x04B4, _RP("Spike")),
	AMIIBO_CHAR_ID_ONE(0x04B6, _RP("Hornsby")),
	AMIIBO_CHAR_ID_ONE(0x04B9, _RP("Merengue")),
#ifdef RP_UTF16
	AMIIBO_CHAR_ID_ONE(0x04BA, _RP("Ren\u00E9e")),
#else /* RP_UTF8 */
	// FIXME: MSVC 2010 interprets \xA9e as 2718 because
	// it's too dumb to realize \x takes *two* nybbles.
	AMIIBO_CHAR_ID_ONE(0x04BA, _RP("Ren\303\251e")),
#endif
	AMIIBO_CHAR_ID_ONE(0x04C5, _RP("Vesta")),
	AMIIBO_CHAR_ID_ONE(0x04C6, _RP("Baabara")),
	AMIIBO_CHAR_ID_ONE(0x04C7, _RP("Eunice")),
	AMIIBO_CHAR_ID_ONE(0x04C8, _RP("Stella")),
	AMIIBO_CHAR_ID_ONE(0x04C9, _RP("Cashmere")),
	AMIIBO_CHAR_ID_ONE(0x04CC, _RP("Willow")),
	AMIIBO_CHAR_ID_ONE(0x04CD, _RP("Curlos")),
	AMIIBO_CHAR_ID_ONE(0x04CE, _RP("Wendy")),
	AMIIBO_CHAR_ID_ONE(0x04CF, _RP("Timbra")),
	AMIIBO_CHAR_ID_ONE(0x04D0, _RP("Frita")),
	AMIIBO_CHAR_ID_ONE(0x04D1, _RP("Muffy")),
	AMIIBO_CHAR_ID_ONE(0x04D2, _RP("Pietro")),
#ifdef RP_UTF16
	AMIIBO_CHAR_ID_VAR(0x04D3, _RP("\u00C9toile"), ac_etoile_variants),
#else /* RP_UTF8 */
	AMIIBO_CHAR_ID_VAR(0x04D3, _RP("\xC3\x89toile"), ac_etoile_variants),
#endif
	AMIIBO_CHAR_ID_ONE(0x04DD, _RP("Peanut")),
	AMIIBO_CHAR_ID_ONE(0x04DE, _RP("Blaire")),
	AMIIBO_CHAR_ID_ONE(0x04DF, _RP("Filbert")),
	AMIIBO_CHAR_ID_ONE(0x04E0, _RP("Pecan")),
	AMIIBO_CHAR_ID_ONE(0x04E1, _RP("Nibbles")),
	AMIIBO_CHAR_ID_ONE(0x04E2, _RP("Agent S")),
	AMIIBO_CHAR_ID_ONE(0x04E3, _RP("Caroline")),
	AMIIBO_CHAR_ID_ONE(0x04E4, _RP("Sally")),
	AMIIBO_CHAR_ID_ONE(0x04E5, _RP("Static")),
	AMIIBO_CHAR_ID_ONE(0x04E6, _RP("Mint")),
	AMIIBO_CHAR_ID_ONE(0x04E7, _RP("Ricky")),
	AMIIBO_CHAR_ID_ONE(0x04E8, _RP("Cally")),
	AMIIBO_CHAR_ID_ONE(0x04EA, _RP("Tasha")),
	AMIIBO_CHAR_ID_ONE(0x04EB, _RP("Sylvana")),
	AMIIBO_CHAR_ID_ONE(0x04EC, _RP("Poppy")),
	AMIIBO_CHAR_ID_ONE(0x04ED, _RP("Sheldon")),
	AMIIBO_CHAR_ID_ONE(0x04EE, _RP("Marshal")),
	AMIIBO_CHAR_ID_ONE(0x04EF, _RP("Hazel")),
	AMIIBO_CHAR_ID_ONE(0x04FA, _RP("Rolf")),
	AMIIBO_CHAR_ID_ONE(0x04FB, _RP("Rowan")),
	AMIIBO_CHAR_ID_ONE(0x04FC, _RP("Tybalt")),
	AMIIBO_CHAR_ID_ONE(0x04FD, _RP("Bangle")),
	AMIIBO_CHAR_ID_ONE(0x04FE, _RP("Leonardo")),
	AMIIBO_CHAR_ID_ONE(0x04FF, _RP("Claudia")),
	AMIIBO_CHAR_ID_ONE(0x0500, _RP("Bianca")),
	AMIIBO_CHAR_ID_ONE(0x050B, _RP("Chief")),
	AMIIBO_CHAR_ID_ONE(0x050C, _RP("Lobo")),
	AMIIBO_CHAR_ID_ONE(0x050D, _RP("Wolfgang")),
	AMIIBO_CHAR_ID_ONE(0x050E, _RP("Whitney")),
	AMIIBO_CHAR_ID_ONE(0x050F, _RP("Dobie")),
	AMIIBO_CHAR_ID_ONE(0x0510, _RP("Freya")),
	AMIIBO_CHAR_ID_ONE(0x0511, _RP("Fang")),
	AMIIBO_CHAR_ID_ONE(0x0513, _RP("Vivian")),
	AMIIBO_CHAR_ID_ONE(0x0514, _RP("Skye")),
	AMIIBO_CHAR_ID_ONE(0x0515, _RP("Kyle")),

	// Star Fox (character series = 0x058)
	AMIIBO_CHAR_ID_ONE(0x0580, _RP("Fox")),
	AMIIBO_CHAR_ID_ONE(0x0581, _RP("Falco")),
	...
	AMIIBO_CHAR_ID_ONE(0x0700, _RP("Wii Fit Trainer")),

	// Kid Icarus (character series = 0x074)
	AMIIBO_CHAR_ID_ONE(0x0740, _RP("Pit")),
	AMIIBO_CHAR_ID_ONE(0x0741, _RP("Dark Pit")),
	AMIIBO_CHAR_ID_ONE(0x0742, _RP("Palutena")),

	// Classic Nintendo (character series = 0x078)
	AMIIBO_CHAR_ID_ONE(0x0780, _RP("Mr. Game & Watch")),
	AMIIBO_CHAR_ID_ONE(0x0781, _RP("R.O.B.")),	// NES/Famicom variant is in Page 22, amiibo series.
	AMIIBO_CHAR_ID_ONE(0x0782, _RP("Duck Hunt")),

	// Mii (character series = 0x07C)
	AMIIBO_CHAR_ID_VAR(0x07C0, _RP("Mii Brawler"), mii_variants),

	// Splatoon (character series = 0x080)
	AMIIBO_CHAR_ID_VAR(0x0800, _RP("Inkling"), splatoon_inkling_variants),
	AMIIBO_CHAR_ID_ONE(0x0801, _RP("Callie")),
	AMIIBO_CHAR_ID_ONE(0x0802, _RP("Marie")),

	// Mario Sports Superstars (character series = 0x09C)
	AMIIBO_CHAR_ID_VAR(0x09C0, _RP("Mario"), mss_mario_variants),
	AMIIBO_CHAR_ID_VAR(0x09C1, _RP("Luigi"), mss_luigi_variants),
	AMIIBO_CHAR_ID_VAR(0x09C2, _RP("Peach"), mss_peach_variants),
	AMIIBO_CHAR_ID_VAR(0x09C3, _RP("Daisy"), mss_daisy_variants),
	AMIIBO_CHAR_ID_VAR(0x09C4, _RP("Yoshi"), mss_yoshi_variants),
	AMIIBO_CHAR_ID_VAR(0x09C5, _RP("Wario"), mss_wario_variants),
	AMIIBO_CHAR_ID_VAR(0x09C6, _RP("Waluigi"), mss_waluigi_variants),
	AMIIBO_CHAR_ID_VAR(0x09C7, _RP("Donkey Kong"), mss_donkey_kong_variants),
	AMIIBO_CHAR_ID_VAR(0x09C8, _RP("Diddy Kong"), mss_diddy_kong_variants),
	AMIIBO_CHAR_ID_VAR(0x09C9, _RP("Bowser"), mss_bowser_variants),
	AMIIBO_CHAR_ID_VAR(0x09CA, _RP("Bowser Jr."), mss_bowser_jr_variants),
	AMIIBO_CHAR_ID_VAR(0x09CB, _RP("Boo"), mss_boo_variants),
	AMIIBO_CHAR_ID_VAR(0x09CC, _RP("Baby Mario"), mss_baby_mario_variants),
	AMIIBO_CHAR_ID_VAR(0x09CD, _RP("Baby Luigi"), mss_baby_luigi_variants),
	AMIIBO_CHAR_ID_VAR(0x09CE, _RP("Birdo"), mss_birdo_variants),
	AMIIBO_CHAR_ID_VAR(0x09CF, _RP("Rosalina"), mss_rosalina_variants),
	AMIIBO_CHAR_ID_VAR(0x09D0, _RP("Metal Mario"), mss_metal_mario_variants),
	AMIIBO_CHAR_ID_VAR(0x09D1, _RP("Pink Gold Peach"), mss_pink_gold_peach_variants),

	// Pokémon (character series = 0x190 - 0x1BC)
	AMIIBO_CHAR_ID_ONE(0x1900+  6, _RP("Charizard")),
	AMIIBO_CHAR_ID_ONE(0x1900+ 25, _RP("Pikachu")),
	AMIIBO_CHAR_ID_ONE(0x1900+ 39, _RP("Jigglypuff")),
	AMIIBO_CHAR_ID_ONE(0x1900+150, _RP("Mewtwo")),
	AMIIBO_CHAR_ID_ONE(0x1900+448, _RP("Lucario")),
	AMIIBO_CHAR_ID_ONE(0x1900+658, _RP("Greninja")),

	// Pokkén Tournament (character series = 0x1D00)
	AMIIBO_CHAR_ID_ONE(0x1D00, _RP("Shadow Mewtwo")),

	// Kirby (character series = 0x1F0)
	AMIIBO_CHAR_ID_ONE(0x1F00, _RP("Kirby")),
	AMIIBO_CHAR_ID_ONE(0x1F01, _RP("Meta Knight")),
	AMIIBO_CHAR_ID_ONE(0x1F02, _RP("King Dedede")),
	AMIIBO_CHAR_ID_ONE(0x1F03, _RP("Waddle Dee")),

	// BoxBoy! (character series = 0x1F4)
	AMIIBO_CHAR_ID_ONE(0x1F40, _RP("Qbby")),

	// Fire Emblem (character series = 0x210)
	AMIIBO_CHAR_ID_ONE(0x2100, _RP("Marth")),
	AMIIBO_CHAR_ID_ONE(0x2101, _RP("Ike")),
	AMIIBO_CHAR_ID_ONE(0x2102, _RP("Lucina")),
	AMIIBO_CHAR_ID_ONE(0x2103, _RP("Robin")),
	AMIIBO_CHAR_ID_ONE(0x2104, _RP("Roy")),
	AMIIBO_CHAR_ID_VAR(0x2105, _RP("Corrin"), fe_corrin_variants),
	AMIIBO_CHAR_ID_ONE(0x2106, _RP("Alm")),
	AMIIBO_CHAR_ID_ONE(0x2107, _RP("Celica")),

	// Xenoblade (character series = 0x224)
	AMIIBO_CHAR_ID_ONE(0x2240, _RP("Shulk")),

	// Earthbound (character series = 0x228)
	AMIIBO_CHAR_ID_ONE(0x2280, _RP("Ness")),
	AMIIBO_CHAR_ID_ONE(0x2281, _RP("Lucas")),

	// Chibi-Robo! (character series = 0x22C)
	AMIIBO_CHAR_ID_ONE(0x22C0, _RP("Chibi Robo")),

	// Sonic the Hedgehog (character series = 0x320)
	AMIIBO_CHAR_ID_ONE(0x3200, _RP("Sonic")),

	// Bayonetta (character series = 0x324)
	AMIIBO_CHAR_ID_ONE(0x3240, _RP("Bayonetta")),

	// Pac-Man (character series = 0x334)
	AMIIBO_CHAR_ID_ONE(0x3340, _RP("Pac-Man")),

	// Mega Man (character series = 0x348)
	AMIIBO_CHAR_ID_ONE(0x3480, _RP("Mega Man")),

	// Street Fighter (character series = 0x34C)
	AMIIBO_CHAR_ID_ONE(0x34C0, _RP("Ryu")),

	// Monster Hunter (character series = 0x350)
	AMIIBO_CHAR_ID_VAR(0x3500, _RP("One-Eyed Rathalos and Rider"), mh_rathalos_variants),
	AMIIBO_CHAR_ID_ONE(0x3501, _RP("Nabiru")),
	AMIIBO_CHAR_ID_VAR(0x3502, _RP("Rathian and Cheval"), mh_rathian_cheval_variants),
	AMIIBO_CHAR_ID_VAR(0x3503, _RP("Barioth and Ayuria"), mh_barioth_ayuria_variants),
	AMIIBO_CHAR_ID_VAR(0x3504, _RP("Qurupeco and Dan"), mh_qurupeco_dan_variants),

	// Shovel Knight (character series = 0x35C)
	AMIIBO_CHAR_ID_ONE(0x35C0, _RP("Shovel Knight")),

	// Final Fantasy (character series = 0x360)
	AMIIBO_CHAR_ID_ONE(0x3600, _RP("Cloud")),
};
