...
class DreamcastPrivate;
class Dreamcast : public LibRpBase::RomData
{
	public:
		/**
		 ...
		 */
		explicit Dreamcast(LibRpBase::IRpFile *file);
	...
	private:
		...
		friend class DreamcastPrivate;
		RP_DISABLE_COPY(Dreamcast)
