...
const uint8_t NCCHReaderPrivate::EncryptionKeyVerifyData[Key_Max][16] = {
	...
	// 0: eShop titles
	{0xB3,0xEC,0x56,0x78,0x2C,0xEE,0x4B,0xB8,
	 0xE9,0x69,0x43,0x98,0xB2,0xE0,0x0B,0x93},
	// 1: System titles
	{0x49,0xB4,0xD4,0x42,0x46,0xD8,0x4A,0x2C,
	 0x46,0x32,0x09,0x52,0x2D,0x8C,0x02,0xA8},
	// 2
	{0x14,0xF4,0xB2,0xE1,0x88,0x2E,0xD6,0xC0,
	 0x8A,0x14,0x03,0x52,0x4B,0xBC,0xB8,0x5B},
	// 3
	{0x1D,0xC7,0xFC,0xE5,0xE5,0x9B,0xE6,0x6D,
	 0x6C,0xED,0xD5,0x39,0x53,0x7B,0xD4,0xAD},
	// 4
	{0xB3,0xCB,0x2E,0x53,0x66,0x91,0x64,0x02,
	 0xE3,0xB9,0xCA,0xCC,0xE8,0x66,0xDF,0xE7},
	// 5
	{0x1B,0xD8,0x95,0x98,0x99,0x4E,0x5F,0xBB,
	 0xBC,0xCE,0x0F,0x95,0x78,0xD6,0x6D,0x38},
