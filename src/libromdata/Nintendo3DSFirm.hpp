...
#ifndef __ROMPROPERTIES_LIBROMDATA_NINTENDO3DSFIRM_HPP__
#define __ROMPROPERTIES_LIBROMDATA_NINTENDO3DSFIRM_HPP__

#include "librpbase/RomData.hpp"

namespace LibRomData {

class Nintendo3DSFirmPrivate;
class Nintendo3DSFirm : public LibRpBase::RomData
{
	public:
		/**
		 ...
		 */
		explicit Nintendo3DSFirm(LibRpBase::IRpFile *file);
	...
	protected:
		 ...
		 * Use unref() instead.
		 */
		virtual ~Nintendo3DSFirm() { }

	private:
		typedef RomData super;
		friend class Nintendo3DSFirmPrivate;
		RP_DISABLE_COPY(Nintendo3DSFirm)
...
#endif /* __ROMPROPERTIES_LIBROMDATA_NINTENDO3DSFIRM_HPP__ */
