...
#ifndef __ROMPROPERTIES_LIBROMDATA_CONFIG_CONFREADER_HPP__
#define __ROMPROPERTIES_LIBROMDATA_CONFIG_CONFREADER_HPP__
...
#endif /* __ROMPROPERTIES_LIBROMDATA_CONFIG_CONFREADER_HPP__ */
