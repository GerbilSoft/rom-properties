...
class NintendoBadgePrivate;
class NintendoBadge : public LibRpBase::RomData
{
	public:
		/**
		 ...
		 */
		explicit NintendoBadge(LibRpBase::IRpFile *file);
	...
	protected:
		 ...
		 * Use unref() instead.
		 */
		virtual ~NintendoBadge() { }

	private:
		typedef RomData super;
		friend class NintendoBadgePrivate;
		RP_DISABLE_COPY(NintendoBadge)
