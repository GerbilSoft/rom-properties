...
INSTANTIATE_TEST_SUITE_P(TGA, ImageDecoderTest,
	::testing::Values(
		...
		ImageDecoderTest_mode("TGA/tga-go/monochrome16_top_left_rle.tga.gz", "TGA/tga-go/monochrome16.png", "A8L8"),
		ImageDecoderTest_mode("TGA/tga-go/monochrome16_top_left.tga.gz", "TGA/tga-go/monochrome16.png", "A8L8"),
...
INSTANTIATE_TEST_SUITE_P(ICO, ImageDecoderTest,
	::testing::Values(
		...
		ICO_IMAGE_TEST("notepad-3.0-1", "CI4"),
		ICO_IMAGE_TEST("notepad-3.1-1", "CI4"),
		ICO_IMAGE_TEST("notepad-4.00.950-1", "CI4"),
		ICO_IMAGE_TEST("notepad-4.00.950-2", "CI4"),
		ICO_IMAGE_TEST("notepad-4.10.1998-2", "CI8"),
		ICO_IMAGE_TEST("notepad-nt11-25h2-i386-300", "ARGB"),
		ICO_IMAGE_TEST("notepad-nt11-25h2-i386-301", "ARGB"),
		ICO_IMAGE_TEST("notepad-nt11-25h2-i386-302", "ARGB"),
		ICO_IMAGE_TEST("notepad-nt35-i386-1", "CI4"),
		ICO_IMAGE_TEST("notepad-nt51-i386-2", "ARGB"),
