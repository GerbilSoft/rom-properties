...
typedef enum {
	...
	SVR_PX_RGB5A3	= 0x08,
	SVR_PX_ARGB8888	= 0x09,

	SVR_PX_MIN = SVR_PX_RGB5A3,
	SVR_PX_MAX = SVR_PX_ARGB8888,
} PVR_Pixel_Format_t;
...
typedef enum {
	...
	SVR_IMG_INDEX4_RGB5A3_RECTANGLE		= 0x66,
	SVR_IMG_INDEX4_RGB5A3_SQUARE		= 0x67,
	SVR_IMG_INDEX4_ARGB8_RECTANGLE		= 0x68,
	SVR_IMG_INDEX4_ARGB8_SQUARE		= 0x69,
	SVR_IMG_INDEX8_RGB5A3_RECTANGLE		= 0x6A,
	SVR_IMG_INDEX8_RGB5A3_SQUARE		= 0x6B,
	SVR_IMG_INDEX8_ARGB8_RECTANGLE		= 0x6C,
	SVR_IMG_INDEX8_ARGB8_SQUARE		= 0x6D,

	SVR_IMG_MIN = SVR_IMG_RECTANGLE,
	SVR_IMG_MAX = SVR_IMG_INDEX8_ARGB8_SQUARE,
