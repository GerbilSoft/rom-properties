...
#ifndef __ROMPROPERTIES_LIBROMDATA_LYNX_HPP__
#define __ROMPROPERTIES_LIBROMDATA_LYNX_HPP__
...
class LynxPrivate;
class Lynx : public LibRpBase::RomData
{
	public:
		/**
		 ...
		 */
		explicit Lynx(LibRpBase::IRpFile *file);
	...
	private:
		...
		friend class LynxPrivate;
		RP_DISABLE_COPY(Lynx)
...
#endif /* __ROMPROPERTIES_LIBROMDATA_LYNX_HPP__ */
