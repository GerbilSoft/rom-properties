 ...
 * ELF.hpp: Executable and Linkable Format reader.                         *
 *                                                                         *
...
#ifndef __ROMPROPERTIES_LIBROMDATA_ELF_HPP__
#define __ROMPROPERTIES_LIBROMDATA_ELF_HPP__
...
class ELFPrivate;
class ELF : public LibRpBase::RomData
{
	public:
		/**
		 ...
		 */
		explicit ELF(LibRpBase::IRpFile *file);
...
#endif /* __ROMPROPERTIES_LIBROMDATA_ELF_HPP__ */
