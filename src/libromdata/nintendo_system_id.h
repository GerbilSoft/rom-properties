...
#ifndef __ROMPROPERTIES_LIBROMDATA_NINTENDO_SYSTEM_ID_H__
#define __ROMPROPERTIES_LIBROMDATA_NINTENDO_SYSTEM_ID_H__
...
#endif /* __ROMPROPERTIES_LIBROMDATA_NINTENDO_SYSTEM_ID_H__ */
