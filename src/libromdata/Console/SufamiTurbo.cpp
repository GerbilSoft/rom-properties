...
int SufamiTurbo::loadFieldData(void)
{
	...
	// Features
	static const char8_t *const features_bitfield_names[] = {
		U8("SlowROM"), U8("FastROM"), U8("SRAM"), U8("Special")
	};
	vector<u8string> *const v_features_bitfield_names = RomFields::strArrayToVector(
