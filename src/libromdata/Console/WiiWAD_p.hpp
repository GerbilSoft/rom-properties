...
#ifndef __ROMPROPERTIES_LIBROMDATA_CONSOLE_WIIWAD_P_HPP__
#define __ROMPROPERTIES_LIBROMDATA_CONSOLE_WIIWAD_P_HPP__
...
#endif /* __ROMPROPERTIES_LIBROMDATA_CONSOLE_WIIWAD_P_HPP__ */
