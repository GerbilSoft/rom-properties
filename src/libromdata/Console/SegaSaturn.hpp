...
#ifndef __ROMPROPERTIES_LIBROMDATA_SEGASATURN_HPP__
#define __ROMPROPERTIES_LIBROMDATA_SEGASATURN_HPP__

#include "librpbase/RomData.hpp"

namespace LibRomData {

class SegaSaturnPrivate;
class SegaSaturn : public LibRpBase::RomData
{
	public:
		/**
		 ...
		 */
		explicit SegaSaturn(LibRpBase::IRpFile *file);
	...
	private:
		...
		friend class SegaSaturnPrivate;
		RP_DISABLE_COPY(SegaSaturn)
...
#endif /* __ROMPROPERTIES_LIBROMDATA_SEGASATURN_HPP__ */
