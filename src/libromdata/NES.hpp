...
class NES : public LibRpBase::RomData
{
	...
	public:
		 ...
		 */
		virtual const rp_char *systemName(unsigned int type) const override;
	...
	public:
		 ...
		 * @return NULL-terminated array of all supported file extensions, or nullptr on error.
		 */
		virtual const rp_char *const *supportedFileExtensions(void) const override;
...
#endif /* __ROMPROPERTIES_LIBROMDATA_NES_HPP__ */
