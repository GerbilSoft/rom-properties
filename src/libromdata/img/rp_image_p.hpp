...
#ifndef __ROMPROPERTIES_LIBROMDATA_IMG_RP_IMAGE_P_HPP__
#define __ROMPROPERTIES_LIBROMDATA_IMG_RP_IMAGE_P_HPP__
...
#endif /* __ROMPROPERTIES_LIBROMDATA_IMG_RP_IMAGE_P_HPP__ */
