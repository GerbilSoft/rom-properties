...
class DirectDrawSurfacePrivate;
class DirectDrawSurface : public LibRpBase::RomData
{
	public:
		/**
		 ...
		 */
		explicit DirectDrawSurface(LibRpBase::IRpFile *file);
	...
	private:
		...
		friend class DirectDrawSurfacePrivate;
		RP_DISABLE_COPY(DirectDrawSurface)
