...
class CreateThumbnail : public LibRomData::TCreateThumbnail<HBITMAP>
{
	...
	public:
		 ...
		 * @return ImgClass
		 */
		HBITMAP rpImageToImgClass(const LibRpTexture::rp_image_const_ptr &img) const override;
...
class CreateThumbnailNoAlpha final : public CreateThumbnail
{
	...
	public:
		 ...
		 * @return ImgClass
		 */
		HBITMAP rpImageToImgClass(const LibRpTexture::rp_image_const_ptr &img) const final;
