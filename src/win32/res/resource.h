...
#define WM_RP_PROP_SHEET_RESET			(WM_APP + 0x1234)
#define WM_RP_PROP_SHEET_DEFAULTS		(WM_APP + 0x1235)
...
#define IDC_XATTRVIEW_NTFS_COMPRESSION_ALG      42006
#define IDC_XATTRVIEW_NTFS_ENCRYPTED		42007
#define IDC_XATTRVIEW_GRPADS                    42008
#define IDC_XATTRVIEW_LISTVIEW_ADS              42009
