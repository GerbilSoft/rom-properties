...
CacheKeyError verifyCacheKey(tstring &outURL, bool &check_newer, const TCHAR *cache_key)
{
	...
	// - md:     https://rpdb.gerbilsoft.com/md/[key]
	// - mcd:    https://rpdb.gerbilsoft.com/mcd/[key]
	// - 32x:    https://rpdb.gerbilsoft.com/32x/[key]
	// - mcd32x: https://rpdb.gerbilsoft.com/mcd32x/[key]
	// - pico:   https://rpdb.gerbilsoft.com/pico/[key]
	// - tera:   https://rpdb.gerbilsoft.com/tera/[key]
