...
IF(MSVC)
	...
	IF(NOT USE_INTERNAL_MinizipNG OR USE_INTERNAL_MinizipNG_DLL)
		SET(DL_DLLS ${DL_DLLS} minizip-ng)
	ENDIF(NOT USE_INTERNAL_MinizipNG OR USE_INTERNAL_MinizipNG_DLL)
	IF(NOT USE_INTERNAL_FMT OR USE_INTERNAL_FMT_DLL)
		SET(DL_DLLS ${DL_DLLS} fmt-12)
	ENDIF(NOT USE_INTERNAL_FMT OR USE_INTERNAL_FMT_DLL)

	IF(ENABLE_NLS)
		SET(DL_DLLS ${DL_DLLS} gnuintl-8)
	ENDIF(ENABLE_NLS)
