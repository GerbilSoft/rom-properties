...
G_DECLARE_FINAL_TYPE(RpExt2AttrView, rp_ext2_attr_view, RP, EXT2_ATTR_VIEW, GtkBox)
#else /* !GTK_CHECK_VERSION(3,0,0) */
G_DECLARE_FINAL_TYPE(RpExt2AttrView, rp_ext2_attr_view, RP, EXT2_ATTR_VIEW, GtkHBox)
#endif
