...
G_DECLARE_FINAL_TYPE(RpAboutTab, rp_about_tab, RP, ABOUT_TAB, GtkBox)
#else /* !GTK_CHECK_VERSION(3,0,0) */
G_DECLARE_FINAL_TYPE(RpAboutTab, rp_about_tab, RP, ABOUT_TAB, GtkVBox)
#endif /* GTK_CHECK_VERSION(3,0,0) */

/* this function is implemented automatically by the G_DEFINE_TYPE macro */
void		rp_about_tab_register_type	(GtkWidget *widget) G_GNUC_INTERNAL;
