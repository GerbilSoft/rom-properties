...
RpKeyStoreItem *rp_key_store_item_new		(const char *name, const char *value, gboolean is_valid, int flat_idx, gboolean is_section) G_GNUC_MALLOC;
RpKeyStoreItem *rp_key_store_item_new_key	(const char *name, const char *value, gboolean is_valid, int flat_idx) G_GNUC_MALLOC;
...
void		rp_key_store_item_set_is_valid	(RpKeyStoreItem *item, gboolean is_valid);
gboolean	rp_key_store_item_get_is_valid	(RpKeyStoreItem *item);
