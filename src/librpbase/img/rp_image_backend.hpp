...
#ifndef __ROMPROPERTIES_LIBRPBASE_IMG_RP_IMAGE_BACKEND_HPP__
#define __ROMPROPERTIES_LIBRPBASE_IMG_RP_IMAGE_BACKEND_HPP__
...
#endif /* __ROMPROPERTIES_LIBRPBASE_IMG_RP_IMAGE_BACKEND_HPP__ */
