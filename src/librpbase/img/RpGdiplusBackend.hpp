...
#ifndef __ROMPROPERTIES_LIBRPBASE_IMG_RPGDIPLUSBACKEND_HPP__
#define __ROMPROPERTIES_LIBRPBASE_IMG_RPGDIPLUSBACKEND_HPP__
...
#endif /* __ROMPROPERTIES_LIBRPBASE_IMG_RPGDIPLUSBACKEND_HPP__ */
