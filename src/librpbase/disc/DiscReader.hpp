...
class DiscReader final : public IDiscReader
{
	public:
		 ...
		 */
		explicit DiscReader(const std::shared_ptr<LibRpFile::IRpFile> &file);
		 ...
		 */
		explicit DiscReader(const std::shared_ptr<LibRpFile::IRpFile> &file, off64_t offset, off64_t length);
	protected:
