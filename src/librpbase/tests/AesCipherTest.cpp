...
static const array<uint8_t, 64> aes128ecb_ciphertext = {{
...
static const array<uint8_t, 64> aes192ecb_ciphertext = {{
...
static const array<uint8_t, 64> aes256ecb_ciphertext = {{
...
static const array<uint8_t, 64> aes128cbc_ciphertext = {{
...
static const array<uint8_t, 64> aes192cbc_ciphertext = {{
...
static const array<uint8_t, 64> aes256cbc_ciphertext = {{
...
static const array<uint8_t, 64> aes128ctr_ciphertext = {{
...
static const array<uint8_t, 64> aes192ctr_ciphertext = {{
...
static const array<uint8_t, 64> aes256ctr_ciphertext = {{
