 ...
 * QTreeWidgetOpt.cpp: QTreeWidget with drawing optimizations.             *
...
QTreeWidgetOpt::QTreeWidgetOpt(QWidget *parent)
	: super(parent)
{ }
...
void QTreeWidgetOpt::dataChanged(const QModelIndex &topLeft,
