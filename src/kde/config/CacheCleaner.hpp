...
#ifndef __ROMPROPERTIES_KDE_CONFIG_CACHECLEANER_HPP__
#define __ROMPROPERTIES_KDE_CONFIG_CACHECLEANER_HPP__
...
#endif /* __ROMPROPERTIES_KDE_CONFIG_CACHECLEANER_HPP__ */