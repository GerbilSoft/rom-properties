 ...
 */
std::shared_ptr<rp_image> fromGcn16(PixelFormat px_format,
 ...
 * @return rp_image, or nullptr on error.
 */
std::shared_ptr<rp_image> fromGcnCI8(int width, int height,
...
std::shared_ptr<rp_image> fromGcnI8(int width, int height,
