...
#ifndef __ROMPROPERTIES_LIBRPTEXTURE_DECODER_IMAGEDECODER_DC_HPP__
#define __ROMPROPERTIES_LIBRPTEXTURE_DECODER_IMAGEDECODER_DC_HPP__
...
#endif /* __ROMPROPERTIES_LIBRPTEXTURE_DECODER_IMAGEDECODER_DC_HPP__ */
