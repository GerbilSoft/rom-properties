...
#ifndef __ROMPROPERTIES_LIBRPTEXTURE_DECODER_IMAGEDECODER_S3TC_HPP__
#define __ROMPROPERTIES_LIBRPTEXTURE_DECODER_IMAGEDECODER_S3TC_HPP__
...
#endif /* __ROMPROPERTIES_LIBRPTEXTURE_DECODER_IMAGEDECODER_S3TC_HPP__ */
