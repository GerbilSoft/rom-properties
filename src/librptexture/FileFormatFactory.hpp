 ...
 */
FileFormatPtr create(const LibRpFile::IRpFilePtr &file);
...
const std::vector<const char*> &supportedFileExtensions(void);
 ...
 */
std::vector<const char*> supportedMimeTypes(void);
