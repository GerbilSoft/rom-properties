...
// rom-properties: No config.h here.
//#include <config.h>

/* Specification.  */
#include "uniwidth.h"

// rom-properties: Disable CJK encoding checks.
//#include "cjk.h"
...
// rom-properties: Remove the 'uniwidth' and 'unictype' subdirectories.
#include "width0.h"
...
// rom-properties: Removed the "encoding" parameter.
int
uc_width (ucs4_t uc/*, const char *encoding*/)
{
  ...
  /* rom-properties: Disabled the ancient CJK encoding check. (UTF-8 only!)
