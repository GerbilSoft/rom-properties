...
#  endif
    ...
    /* ROM Properties NOTE: This differs from the original Intel SSE2
     * implementation by unconditionally enabling SSE2 if requested.
     * We're only compiling filter_sse2_intrinsics.c with SSE2
     * enabeld, because the compiler will otherwise add SSE2 instructions
